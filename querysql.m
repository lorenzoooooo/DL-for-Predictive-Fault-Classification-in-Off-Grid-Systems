...
query = ['SELECT StoricoAnalogiche.DataMisura, StoricoAnalogiche.Count,  StoricoAnalogiche.Cod7 , StoricoAnalogiche.diag' ...
    ...
    'or StoricoAnalogiche.Cod7 = 173 or StoricoAnalogiche.Cod7= 180' ...
    'or StoricoAnalogiche.Cod7=464 or StoricoAnalogiche.Cod7=465 or StoricoAnalogiche.Cod7= 184 or StoricoAnalogiche.Cod7= 185) ' ...
    'and StoricoAnalogiche.Tag like (''%.16399.%'') and StoricoAnalogiche.DataMisura > ''2021-05-01 01:00:00.000'' ' ...
    'ORDER BY StoricoAnalogiche.DataMisura ASC'];

% Execute query and fetch results
sqldata_grezzo = fetch(conn,query);
