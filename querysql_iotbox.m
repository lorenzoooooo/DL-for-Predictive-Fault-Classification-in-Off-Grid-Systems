...
query = ['SELECT StoricoAnalogiche.DataMisura, StoricoAnalogiche.Count,  StoricoAnalogiche.Cod7 , StoricoAnalogiche.diag' ...
    ...
    'WHERE StoricoAnalogiche.Cod7 IN (SELECT Tab7.ID where StoricoAnalogiche.Cod7 = 173 or StoricoAnalogiche.Cod7= 180 or StoricoAnalogiche.Cod7=464 or StoricoAnalogiche.Cod7=465 or StoricoAnalogiche.Cod7= 184) ' ...
